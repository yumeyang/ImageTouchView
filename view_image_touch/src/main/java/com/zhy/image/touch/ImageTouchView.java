...
public class ImageTouchView extends View {
    ...
    private boolean mAutoMoveTop = false;
    ...
    public void setAutoLayout(boolean autoLayout) {
        this.mAutoLayout = autoLayout;
    }

    public boolean isAutoMoveTop() {
        return mAutoMoveTop;
    }

    public void setAutoMoveTop(boolean autoMoveTop) {
        this.mAutoMoveTop = autoMoveTop;
    }
    ...
    private void obtainStyledAttributes(AttributeSet attrs) {
        ...
        frameColor = mTypedArray.getColor(R.styleable.ImageTouchView_frameColor, getResources().getColor(android.R.color.white));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (null != mViewGroup && mAutoLayout) {
...
//     layout(newPaddingLeft, newPaddingTop, newPaddingLeft + actualWidth, newPaddingTop + actualHeight); 
    ...
    private void moveParentTop() {
        if (mAutoMoveTop) {
            ViewGroup view = ((ViewGroup) getParent());
            view.removeView(this);
            view.addView(this, view.getChildCount());
        }
    }
} 
